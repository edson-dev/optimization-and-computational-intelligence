...
if __name__ == "__main__":
    ...
    with RepositorySQL("sqlite:///./masters.db") as repo:
        a = repo.upsert("optimization", {"algorithm": "kendall","base": file_name,"target": melhor_target, "order": str(melhor_ordem), "structure": str(melhor_estrutura), "score": melhor_score, "time": execution_time, "xmlbit": file_path},keys=["algorithm","base"])
